...
```
$ curl -OL https://github.com/moritzzimmer/func/releases/download/v/func__darwin_amd64.tar.gz
$ tar -xvzf func__darwin_amd64.tar.gz
...
```
$ wget https://github.com/moritzzimmer/func/releases/download/v/func__linux_amd64.tar.gz
$ tar -xvzf func__linux_amd64.tar.gz
