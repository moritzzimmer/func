...
```
$ curl -OL https://github.com/moritzzimmer/func/releases/download/v0.0.16/func_0.0.16_darwin_amd64.tar.gz
$ tar -xvzf func_0.0.16_darwin_amd64.tar.gz
...
```
$ wget https://github.com/moritzzimmer/func/releases/download/v0.0.16/func_0.0.16_linux_amd64.tar.gz
$ tar -xvzf func_0.0.16_linux_amd64.tar.gz
