...
```
$ curl -OL https://github.com/moritzzimmer/func/releases/download/v0.0.11/func_0.0.11_darwin_amd64.tar.gz
$ tar -xvzf func_0.0.11_darwin_amd64.tar.gz
...
```
$ wget https://github.com/moritzzimmer/func/releases/download/v0.0.11/func_0.0.11_linux_amd64.tar.gz
$ tar -xvzf func_0.0.11_linux_amd64.tar.gz
