...
```
$ curl -OL https://github.com/moritzzimmer/func/releases/download/v0.0.20/func_0.0.21_darwin_amd64.tar.gz
...
```
$ wget https://github.com/moritzzimmer/func/releases/download/v0.0.20/func_0.0.21_linux_amd64.tar.gz
