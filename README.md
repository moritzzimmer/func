...
```
$ curl -OL https://github.com/spring-media/func/releases/download/v0.0.7/func_0.0.7_darwin_amd64.tar.gz
$ tar -xvzf func_0.0.7_darwin_amd64.tar.gz
...
```
$ wget https://github.com/spring-media/func/releases/download/v0.0.7/func_0.0.7_linux_amd64.tar.gz
$ tar -xvzf func_0.0.7_linux_amd64.tar.gz
